...
def batch_type_name(batch_type):
    return enum_to_str(BatchType, batch_type)
...
def dump_preamble_file(file_name, buf):
    ...
    print(f'parsing preamble file {file_name} preamble:{preamble}')
...
from reinforcement_learning.messages.flatbuff.v2.FileHeader import FileHeader
from reinforcement_learning.messages.flatbuff.v2.JoinedPayload import JoinedPayload
from reinforcement_learning.messages.flatbuff.v2.BatchType import BatchType
